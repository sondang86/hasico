...
<div id="jsjobs_info_heading"><?php echo JText::_('JS_CURRENCY'); ?></div>	
				...
				<table class="adminlist" border="0">
					<thead>
						<tr>
							...
							<th><?php echo JText::_('JS_CURRENCY'); ?></th>
							<th><?php echo JText::_('JS_CODE'); ?></th>
					...
					for ($i=0, $n=count( $this->items ); $i < $n; $i++)
					{
						...
						<tr valign="top" class="<?php echo "row$k"; ?>">
							...
							<td align="center"><?php  $img = $row->status ? 'tick.png' : 'publish_x.png';?><img src="../components/com_jsjobs/images/<?php echo $img;?>" width="16" height="16" border="0" alt="<?php echo $alt; ?>" /></td>
							<td align="center">
								<?php if ($i != 0 ) {  ?>		
									<a href="index.php?option=com_jsjobs&c=common&task=defaultorderingdown&for=currencies&id=<?php echo $row->id;?>">
									<img src="../components/com_jsjobs/images/<?php echo $upimg;?>" width="16" height="16" border="0" alt="Order Up" /></a>
								<?php } else echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';?>	
								<?php echo $row->ordering; ?>
								<?php if ($i < $n-1) { ?>
									<a href="index.php?option=com_jsjobs&c=common&task=defaultorderingup&for=currencies&id=<?php echo $row->id;?>">
