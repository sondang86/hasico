...
<table width="100%">
	<tr>
		...
		<td width="100%" valign="top">
			...
			<input type="hidden" name="layout" value="jobseekerpaymentdetails" />
			...
			?>
			    ...
			    <table cellpadding="2" cellspacing="4" border="1" width="100%" class="adminform">
			      <tr align="center" height="55" valign="middle" class="row1">
			         <td align="center" colspan="2" valign="middle"><h1><center><?php echo $this->items->packagetitle;?></h1></center>
			      </tr>
				    <tr align="left" valign="middle" class="<?php $isodd=1-$isodd; echo $trclass[$isodd];?>">
				  ...
				  <tr align="left" valign="middle" class="<?php $isodd=1-$isodd; echo $trclass[$isodd];?>">
				   ...
				   <tr align="left" valign="middle" class="<?php $isodd=1-$isodd; echo $trclass[$isodd];?>">
			         <td align="left" valign="top"><?php echo JText::_('JS_PAYER_ITEMNAME1') . ' :<strong> </td><td>' . $this->items->payer_itemname1.'</strong>'; ?></td>
			      </tr>
				  <tr align="left" valign="middle" class="<?php $isodd=1-$isodd; echo $trclass[$isodd];?>">
				  ...
				  <?php if($this->items->transactionautoverified == 1) {?>
				    <tr align="left" valign="middle" class="<?php $isodd=1-$isodd; echo $trclass[$isodd];?>">
