...
<table width="100%">
	<tr>
		...
		<td width="100%" valign="top">
				<div id="jsjobs_info_heading"><?php echo JText::_('JS_JOBS_APPROVAL_QUEUE'); ?></div>
			...
			$k = 0;
				...
				for ($i=0, $n=count( $this->items ); $i < $n; $i++)
				{
					...
					<tr valign="top" class="<?php echo "row$k"; ?>">
						...
						<td style="text-align: center;">
							<a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','job.<?php echo $approvetask;?>')">
								<img src="../components/com_jsjobs/images/<?php echo $approveimg;?>" width="16" height="16" border="0" alt="<?php echo $approvealt; ?>" /></a>
							&nbsp;&nbsp; - &nbsp;&nbsp
							<a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','job.<?php echo $rejecttask;?>')">
