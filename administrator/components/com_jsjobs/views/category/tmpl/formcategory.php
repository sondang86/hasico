...
<table width="100%" >
	...
	?>
	 <tr>
        <td width="100%" align="center"><label for="cat_title"><?php echo JText::_('JS_CATEGORY_TITLE'); ?> : </label>
		  &nbsp;&nbsp;&nbsp;<input class="inputbox required" type="text" name="cat_title" id="cat_title" size="40" maxlength="255" value="<?php if(isset($this->application)) echo $this->application->cat_title; ?>" />
        </td>
      </tr>
      <tr>
