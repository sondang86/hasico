				...
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td align="center">
						<?php if($row->isactive == 1){ // published ?>
							<a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','category.unpublishcategories')">
									<img src="../components/com_jsjobs/images/tick.png" width="16" height="16" border="0" alt="<?php echo JText::_( 'Published' ); ?>" /></a>
						<?php }else{ // published ?>
							<a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','category.publishcategories')">
