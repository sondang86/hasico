	...
	?>
	 <tr>
        <td width="100%" align="center">
            <label id="namemsg" for="title"><?php echo JText::_('JS_TITLE'); ?> : </label>
		  &nbsp;&nbsp;&nbsp;<input class="inputbox required" type="text" id="title" name="title" size="40" maxlength="255" value="<?php if(isset($this->application)) echo $this->application->title; ?>" />
        </td>
      </tr>
      <tr>
