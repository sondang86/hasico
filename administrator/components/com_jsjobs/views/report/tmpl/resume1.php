...
<table cellpadding="5" cellspacing="0" border="0" width="100%" class="admintable" >
			...
			<?php
				...
				<table cellpadding="5" cellspacing="0" border="0" width="100%" >
						...
						<tr>
							...
							<?php echo $this->resume->symbol.$this->resume->rangestart.' - '.$this->resume->symbol.$this->resume->rangeend .' '. JText::_('JS_PERMONTH'); ?></td>
						</tr>
						<?php break; 
						case "jobtype":  ?>
						<tr>
						...
						<tr>
							...
							<td class="maintext"><?php echo $this->resume->date_start; ?></td>
						</tr>
					<?php break; 
			...
			<td class="maintext"><?php if (isset($this->resume)) echo $this->resume->institute3_certificate_name;?></td>
				...
				<tr>
				<td class="maintext"><b><?php echo JText::_('JS_STATE'); ?></b></td>
				<td class="maintext" id="institute3_state"><?php if ($this->resume2->institute3_state2 !='')
				echo $this->resume2->institute3_state2; else echo $this->resume->institute3_state;?></td>
				</tr>
				<?php } ?>
				<?php break;
				...
				<tr>
				<td class="maintext"><b><?php echo JText::_('JS_COUNTY'); ?></b></td>
				<td class="maintext" id="institute3_county"><?php if ($this->resume2->institute3_county2 !='')
				echo $this->resume2->institute3_county2; else echo $this->resume->institute3_county;?></td>
				</tr>
				<?php } ?>
				<?php break;*/
				...
				<tr>
				<td class="maintext"><b><?php echo JText::_('JS_CITY'); ?></b></td>
				<td class="maintext" id="institute3_city"><?php if ($this->resume2->institute3_city2 !='')
				echo $this->resume2->institute3_city2; else echo $this->resume->institute3_city;?></td>
				</tr>
				<?php } ?>
				<?php break;
