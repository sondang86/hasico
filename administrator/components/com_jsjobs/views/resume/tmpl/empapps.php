...
$status = array(
	'1' => JText::_('EMP_APP_APPROVED'),
	'-1' => JText::_('EMP_APP_REJECTED'));
...
<table width="100%">
	<tr>
		...
		<td width="100%" valign="top">
				<div id="jsjobs_info_heading"><?php echo JText::_('JS_RESUME'); ?></div>
			...
			$k = 0;
				...
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td style="text-align: center;">
							<a href="javascript:void(0);" onclick="return confirmdeleteresume('cb<?php echo $i;?>','resume.<?php echo $resumedeletetask;?>');" >
