 ...
 * Created on:	Jan 11, 2009
 ^
 + Project: 		JS Jobs
 * File Name:	views/application/tmpl/view resume.php
 ^ 
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" >
	...
	<tr><td class="curloc">
		<?php echo JText::_('JS_CUR_LOC'); ?> : <?php echo JText::_('JS_EMP_APP_FORM'); ?>
	</td></tr>
	<?php } ?>
	<tr><td>
		<?php 
	...
	<tr><td class="<?php echo $this->theme['heading']; ?>" align="center">
		<?php echo JText::_('JS_EMP_APP_FORM'); ?>
	</td></tr>
	<tr><td height="3"></td></tr>
</table>
<?php
				...
				foreach($this->fieldsordering as $field){ 
					...
					switch ($field->field) {
						case "section_personal": ?>
								<?php echo $pane->startPanel(JText::_('JS_PERSONAL')); ?>
									<table cellpadding="5" cellspacing="0" border="0" width="100%" class="admintable" >
									<tr>
					...
					<?php break;
						case "section_addresses": ?>
							...
							<?php  echo $pane->endPanel(); ?>
								<?php echo $pane->startPanel(JText::_('JS_ADDRESSES')); ?>
									<table cellpadding="5" cellspacing="0" border="0" width="100%" class="admintable" >
					...
					<?php break;
						case "section_education": ?>
							...
							<?php  echo $pane->endPanel(); ?>
								<?php echo $pane->startPanel(JText::_('JS_EDUCATIONS')); ?>
									<table cellpadding="5" cellspacing="0" border="0" width="100%" class="admintable" >
										<?php  if (($section_education == 1) && ($section_sub_institute == 1)) { ?>
											<tr>
												<td width="100" colspan="2" align="center" class="<?php echo $this->theme['sectionheading']; ?>">
													<?php echo JText::_('JS_HIGH_SCOOL'); ?>
												</td>
											</tr>
										<?php } ?>
						...
						case "institute_country":  $isodd = 1 - $isodd; ?>
							<?php  if (($section_education == 1) && ($section_sub_institute == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<?php echo $this->resume->institute_country; ?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
							...
							<?php  if (($section_education == 1) && ($section_sub_institute == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<td id="institute_state">
										<?php if ($this->resume->institute_state2 !='') echo $this->resume->institute_state2; else echo $this->resume->institute_state;?>
								</td>
								</tr>
							<?php } ?>
					<?php break;
						case "institute_county":  $isodd = 1 - $isodd; ?>
							<?php  if (($section_education == 1) && ($section_sub_institute == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<?php if ($this->resume->institute_county2 !='') echo $this->resume->institute_county2; else echo $this->resume->institute_county;?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
							...
							<?php  if (($section_education == 1) && ($section_sub_institute == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
										...
										<td id="institute_city">
											<?php if ($this->resume->institute_city2 !='') echo $this->resume->institute_city2; else echo $this->resume->institute_city;?>
										</td>
								</tr>
							<?php } ?>
						...
						case "institute1_country":  $isodd = 1 - $isodd; ?>
							<?php  if (($section_education == 1) && ($section_sub_institute1 == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<?php echo $this->resume->institute1_country; ?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
							...
							<?php  if (($section_education == 1) && ($section_sub_institute1 == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<td id="institute1_state">
										<?php if ($this->resume->institute1_state2 !='') echo $this->resume->institute1_state2; else echo $this->resume->institute1_state;?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
							...
							<?php  if (($section_education == 1) && ($section_sub_institute1 == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<td id="institute1_county">
										<?php if ($this->resume->institute1_county2 !='') echo $this->resume->institute1_county2; else echo $this->resume->institute1_county;?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
							...
							<?php  if (($section_education == 1) && ($section_sub_institute1 == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
										...
										<td id="institute1_city">
											<?php if ($this->resume->institute1_city2 !='') echo $this->resume->institute1_city2; else echo $this->resume->institute1_city;?>
										</td>
								</tr>
							<?php } ?>
					<?php break;
						case "section_sub_institute2": ?>
							<?php  if (($section_education == 1) && ($section_sub_institute2 == 1)) { ?>
								...
								<tr>
									<td width="100" colspan="2" align="center" class="<?php echo $this->theme['sectionheading']; ?>">
										<?php echo JText::_('JS_GRADE_SCOOL'); ?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
						...
						case "institute2_country":  $isodd = 1 - $isodd; ?>
							<?php  if (($section_education == 1) && ($section_sub_institute2 == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<?php echo $this->resume->institute2_country; ?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
							...
							<?php  if (($section_education == 1) && ($section_sub_institute2 == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<td id="institute2_state">
										<?php if ($this->resume->institute2_state2 !='') echo $this->resume->institute2_state2; else echo $this->resume->institute2_state;?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
							...
							<?php  if (($section_education == 1) && ($section_sub_institute2 == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<td id="institute2_county">
										<?php if ($this->resume->institute2_county2 !='') echo $this->resume->institute2_county2; else echo $this->resume->institute2_county;?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
						case "institute2_city":  $isodd = 1 - $isodd; ?>
							<?php  if (($section_education == 1) && ($section_sub_institute2 == 1)) { ?>
								<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
									...
									<?php if ($this->resume->institute2_city2 !='') echo $this->resume->institute2_city2; else echo $this->resume->institute2_city;?>
										</td>
								</tr>
							<?php } ?>
					<?php break;
						case "section_sub_institute3": ?>
							<?php  if (($section_education == 1) && ($section_sub_institute3 == 1)) { ?>
								...
								<tr>
									<td width="100" colspan="2" align="center" class="<?php echo $this->theme['sectionheading']; ?>">
										<?php echo JText::_('JS_OTHER_SCOOL'); ?>
									</td>
								</tr>
							<?php } ?>
					<?php break;
					...
					<?php break;
						case "section_employer": ?>
							...
							<?php  echo $pane->endPanel(); ?>
								<?php echo $pane->startPanel(JText::_('JS_EMPLOYERS')); ?>
									<table cellpadding="5" cellspacing="0" border="0" width="100%" class="admintable" >
						...
						case "employer_country":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer_country">
									<?php echo $this->resume->employer_country; ?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "employer_state":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer_state">
										<?php if ($this->resume->employer_state2 !='') echo $this->resume->employer_state2; else echo $this->resume->employer_state;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						...
						case "employer1_country":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer1_country">
									<?php echo $this->resume->employer1_country; ?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "employer1_state":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer1_state">
										<?php if ($this->resume->employer1_state2 !='') echo $this->resume->employer1_state2; else echo $this->resume->employer1_state;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "employer1_county":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer1_county">
										<?php if ($this->resume->employer1_county2 !='') echo $this->resume->employer1_county2; else echo $this->resume->employer1_county;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "employer1_city":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer1_city">
										<?php if ($this->resume->employer1_city2 !='') echo $this->resume->employer1_city2; else echo $this->resume->employer1_city;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						...
						case "employer2_country":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer2_country">
									<?php echo $this->resume->employer2_country; ?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "employer2_state":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer2_state">
										<?php if ($this->resume->employer2_state2 !='') echo $this->resume->employer2_state2; else echo $this->resume->employer2_state;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "employer2_county":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer2_county">
										<?php if ($this->resume->employer2_county2 !='') echo $this->resume->employer2_county2; else echo $this->resume->employer2_county;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "employer2_city":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer2_city">
										<?php if ($this->resume->employer2_city2 !='') echo $this->resume->employer2_city2; else echo $this->resume->employer2_city;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
				...
				<?php break;
						...
						case "employer3_country":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer3_country">
									<?php echo $this->resume->employer3_country; ?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "employer3_state":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer3_state">
										<?php if ($this->resume->employer3_state2 !='') echo $this->resume->employer3_state2; else echo $this->resume->employer3_state;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "employer3_county":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer3_county">
										<?php if ($this->resume->employer3_county2 !='') echo $this->resume->employer3_county2; else echo $this->resume->employer3_county;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "employer3_city":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="employer3_city">
										<?php if ($this->resume->employer3_city2 !='') echo $this->resume->employer3_city2; else echo $this->resume->employer3_city;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
					...
					<?php break;
						case "section_skills": ?>
							...
							<?php  echo $pane->endPanel(); ?>
							<?php echo $pane->startPanel(JText::_('JS_SKILLS')); ?>
								<table cellpadding="5" cellspacing="0" border="0" width="100%" class="admintable" >
									<tr>
										<td width="100" colspan="2" align="center" class="<?php echo $this->theme['sectionheading']; ?>">
					...
					<?php break;
						case "section_resumeeditor": ?>
							...
							<?php  echo $pane->endPanel(); ?>
							<?php echo $pane->startPanel(JText::_('JS_RESUME')); ?>
								<table cellpadding="5" cellspacing="0" border="0" width="100%" class="admintable" >
									<tr>
										<td width="100" colspan="2" align="center" class="<?php echo $this->theme['sectionheading']; ?>">
								...
								<?php if (isset($this->resume)) 
										...
										<tr height="21"><td colspan="2"></td></tr>
											<tr>
												...
												<?php $link = $mainframe->getBasePath().'components/com_jsjobs/data/jobseeker/resume_'.$this->resume->id.'/resume/'.$this->resume->filename; ?>
					...
					<?php break;
						case "section_references": ?>
							...
							<?php  echo $pane->endPanel(); ?>
								<?php echo $pane->startPanel(JText::_('JS_REFERENCES')); ?>
									<table cellpadding="5" cellspacing="0" border="0" width="100%" class="admintable" >
					...
					<?php break;
						case "reference_country":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<?php echo $this->resume2->reference_country; ?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "reference_state":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="reference_state">
										<?php if ($this->resume2->reference_state2 !='') echo $this->resume2->reference_state2; else echo $this->resume2->reference_state;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "reference_county":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="reference_county">
										<?php if ($this->resume2->reference_county2 !='') echo $this->resume2->reference_county2; else echo $this->resume2->reference_county;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
						case "reference_city":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
						        ...
						        <td id="reference_city">
										<?php if ($this->resume2->reference_city2 !='') echo $this->resume2->reference_city2; else echo $this->resume2->reference_city;?>
								</td>
							</tr>
							<?php } ?>
					<?php break;
					...
					<?php break;
						case "reference1_country":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<?php echo $this->resume2->reference1_country; ?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
						case "reference1_state":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="reference1_state">
										<?php if ($this->resume2->reference1_state2 !='') echo $this->resume2->reference1_state2; else echo $this->resume2->reference1_state;?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
						case "reference1_county":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="reference1_county">
										<?php if ($this->resume2->reference1_county2 !='') echo $this->resume2->reference1_county2; else echo $this->resume2->reference1_county;?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
						case "reference1_city":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
						        ...
						        <td id="reference1_city">
										<?php if ($this->resume2->reference1_city2 !='') echo $this->resume2->reference1_city2; else echo $this->resume2->reference1_city;?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
					...
					<?php break;
						case "reference2_country":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<?php echo $this->resume2->reference2_country; ?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
						case "reference2_state":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="reference2_state">
										<?php if ($this->resume2->reference2_state2 !='') echo $this->resume2->reference2_state2; else echo $this->resume2->reference2_state;?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
						case "reference2_county":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="reference2_county">
										<?php if ($this->resume2->reference2_county2 !='') echo $this->resume2->reference2_county2; else echo $this->resume2->reference2_county;?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
						case "reference2_city":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
						        ...
						        <td id="reference2_city">
										<?php if ($this->resume2->reference2_city2 !='') echo $this->resume2->reference2_city2; else echo $this->resume2->reference2_city;?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
					...
					<?php break;
						case "reference3_country":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<?php echo $this->resume2->reference3_country; ?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
						case "reference3_state":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="reference3_state">
										<?php if ($this->resume2->reference3_state2 !='') echo $this->resume2->reference3_state2; else echo $this->resume2->reference3_state;?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
						case "reference3_county":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
								...
								<td id="reference3_county">
										<?php if ($this->resume2->reference3_county2 !='') echo $this->resume2->reference3_county2; else echo $this->resume2->reference3_county;?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
						case "reference3_city":  $isodd = 1 - $isodd; ?>
							...
							<tr class="<?php echo $this->theme[$trclass[$isodd]]; ?>">
						        ...
						        <td id="reference3_city">
										<?php if ($this->resume2->reference3_city2 !='') echo $this->resume2->reference3_city2; else echo $this->resume2->reference3_city;?>
								</td>
							</tr>
						<?php } ?>	
					<?php break;
