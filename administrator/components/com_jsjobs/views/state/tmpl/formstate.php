 ...
 * Created on:	Jan 11, 2009
 ^
 + Project: 		JS Jobs
 * File Name:	admin-----/views/application/tmpl/formstate.php
 * 
 * Description: Form template for state
 * 
 * History:		NONE
 * 
 */
	 ...
	 <tr>
      ...
      <tr>
        <td align="center"><?php echo JText::_('JS_PUBLISHED'); ?> : 
		  &nbsp;&nbsp;&nbsp;<input type="checkbox" name="enabled" value="1" <?php if(isset($this->state))  {if ($this->state->enabled == '1') echo 'checked';} ?>/>
		  </td>
      </tr>
