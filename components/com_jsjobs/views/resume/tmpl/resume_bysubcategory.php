...
if (isset($this->resume[0])){
			if ($this->resume[0]->cat_title != '') $ptitle = $this->resume[0]->cat_title; 
			if ($this->resume[0]->subcategory != '') $ptitle .= ' : '.$this->resume[0]->subcategory;
			...
			if ($this->subcategorytitle->cat_title != '') $ptitle = $this->subcategorytitle->cat_title; 
			if ($this->subcategorytitle->subcategory != '') $ptitle .= ' : '.$this->subcategorytitle->subcategory;
