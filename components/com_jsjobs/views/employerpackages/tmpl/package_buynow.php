...
<form action="index.php" method="post" name="adminForm">
        ...
        <div id="js_main_wrapper">
            ...
            <div class="js_listing_wrapper paymentmethod <?php if($n == 1) echo 'first-child';?>">
                ...
                <span class="payment_method_button"><input id="jsjobs_button"  class="js_job_button" rel="button" type="button" onclick="setpaymentmethods('<?php echo $key ; ?>')" name="submit_app" value="<?php echo JText::_('JS_BUY_NOW'); ?>" /></span>
            </div>			
				<?php   $n = $n +1;
					}
					}
