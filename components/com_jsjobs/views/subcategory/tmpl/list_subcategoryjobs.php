...
if(isset($this->jobs[0]->subcategoryaliasid))$link = "index.php?option=com_jsjobs&c=jsjobs&view=subcategory&layout=list_subcategoryjobs&jobsubcat=". $this->jobs[0]->subcategoryaliasid."&Itemid=".$this->Itemid;
...
if (isset($this->jobs[0])){
    if ($this->jobs[0]->cat_title != '') $ptitle = $this->jobs[0]->cat_title; 
    if ($this->jobs[0]->subcategory != '') $ptitle .= ' : '.$this->jobs[0]->subcategory;
}else $ptitle = $_GET['cn'];
$ptitle =  $ptitle;
