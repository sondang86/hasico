...
$tcparams     = $template->params;
$fblang   = $tcparams->get('fb_lang', 'en_US');
...
<article id="k2Container" class="itemView single-page <?php echo $k2ContainerClasses; ?>"> <?php echo $this->item->event->BeforeDisplay; ?> <?php echo $this->item->event->K2BeforeDisplay; ?>
          <header<?php if(!($params->get('itemImage') && !empty($this->item->image))): ?> class="no-image"<?php endif; ?>>
	      ...
	      <div class="itemInfo mx-clearfix">   
	          ...
	          <div class="itemAuthor">
		            ...
		            <span class="itemAuthorUrl">
		            	<a rel="me" href="<?php echo $this->item->author->profile->url; ?>" class="inverse" target="_blank">
		            		<?php echo JText::_('TPL_GK_LANG_AUTHOR_PAGE'); ?>
		            	</a>
		            </span>
		            <?php endif; ?>
	          </div>
          ...
          <ul class="itemAdditionalInfo mx-clearfix">
                    ...
                    <li class="itemPrint">
                    	<a rel="nofollow" href="<?php echo $this->item->printLink; ?>" class="inverse" onclick="window.open(this.href,'printWindow','width=900,height=600,location=no,menubar=no,resizable=yes,scrollbars=yes'); return false;"><?php echo JText::_('K2_PRINT'); ?></a>
                    </li>
                    <?php endif; ?>
                    <?php if($params->get('itemEmailButton') && !JRequest::getInt('print')): ?>
                    <li class="itemEmail">
                    	<a rel="nofollow" class="inverse" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;"><?php echo JText::_('K2_EMAIL'); ?></a>
                    </li>
                    <?php endif; ?>
          ...
          <div class="item-content">
                    <div class="itemBody"> 
                    		...
                    		<?php echo $this->item->event->K2BeforeDisplayContent; ?>
                              ...
                              <div class="itemFullText"> <?php echo (!empty($this->item->fulltext)) ? $this->item->fulltext : $this->item->introtext; ?> </div><?php endif; ?>
                    ...
                    <div class="itemBottom mx-clearfix">
                    ...
                    <div class="itemAuthorContent">
                              ...
                              <ul data-cols="<?php echo count($this->relatedItems); ?>">
                                        ...
                                        <li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
                                                  ...
                                                  <?php endif; ?>
                                                  <a class="itemRelTitle itemRelTitleLink" href="<?php echo $item->link ?>"><?php echo $item->title; ?></a> </li>
                                        <?php endforeach; ?>
                              </ul>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="itemNavigation"> 
                    	<h3><?php echo JText::_('K2_MORE_IN_THIS_CATEGORY'); ?></h3>
                              <?php if(isset($this->item->previousLink)): ?>
                              <a class="button button-border itemPrevious" href="<?php echo $this->item->previousLink; ?>">&laquo; <?php echo $this->item->previousTitle; ?></a>
                              <?php endif; ?>
                              <?php if(isset($this->item->nextLink)): ?>
                              <a class="button button-border itemNext" href="<?php echo $this->item->nextLink; ?>"><?php echo $this->item->nextTitle; ?> &raquo;</a>
                              <?php endif; ?>
                    </div>
                    <?php endif; ?>
