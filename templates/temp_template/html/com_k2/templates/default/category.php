...
<div id="k2Container" class="category itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
          ...
          <div class="itemListCategoriesBlock">
                    ...
                    <div class="itemsCategory mx-clearfix">
                          ...
                          <h1> 
                      		...
                      		<span>(<?php echo $this->pagination->total; ?>)</span>
                      		<?php endif; ?>
                          </h1>
                          <?php endif; ?>
                          
                          <?php if($this->params->get('catDescription') && $this->category->description != '' ): ?>
                          <p class="categoryDescription"><?php echo strip_tags($this->category->description); ?></p>
                          <?php endif; ?>

                          <?php if(isset($this->addLink)): ?>
                          <a class="catItemAddLink modal" rel="{handler:'iframe',size:{x:990,y:650}}" href="<?php echo $this->addLink; ?>"> <?php echo JText::_('K2_ADD_A_NEW_ITEM_IN_THIS_CATEGORY'); ?> </a>
                          <?php endif; ?>
                    ...
                    <div class="itemListSubCategories mx-clearfix">
				...
				?>
                              <div class="subCategoryContainer<?php echo $lastContainer; ?>"<?php echo (count($this->subCategories)==1) ? '' : ' style="width:'.(number_format(100/$this->params->get('subCatColumns'), 1)-0.1).'%;"'; ?>>
                                        <div class="subCategory">
                                                  ...
                                                  <p class="categoryDescription"><?php echo $subCategory->description; ?> <a class="subCategoryViewItems" href="<?php echo $subCategory->link; ?>"> <?php echo JText::_('K2_VIEW_ITEMS'); ?> </a> </p>
                                                  <?php endif; ?>
                                         </div>
                              </div>
