...
<section id="k2Container" class="category itemListView latest-cols-<?php echo $this->params->get('latestItemsCols'); ?> latestView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
          ...
          <div class="itemsContainer" style="width:<?php echo number_format(99.0/$this->params->get('latestItemsCols'), 1); ?>%;">
                    ...
                    <div class="itemsCategory mx-clearfix">
                              ...
                              <p class="categoryDescription"><?php echo strip_tags($category->description); ?></p>
                              <?php endif; ?>
                    ...
                    <div class="itemAuthorData">
                              ...
                              <div class="itemAuthorDetails">
                                        ...
                                        <p><?php echo strip_tags($user->profile->description); ?></p>
                                        <?php endif; ?>
                                        <?php if(
							(
                    ...
                    <div class="itemList">
                              ...
                              <?php $this->item=$item; echo $this->loadTemplate('item' . ($this->params->get('latestItemsCols') > 2 ? '' : '')); ?>
                              <?php else: ?>
                              ...
                              <?php endforeach; ?>
                              <?php endif; ?>
                              <?php if($category->feed && $this->params->get('categoryFeed')): ?>
